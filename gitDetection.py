...
contours, hierarchy = cv2.findContours(edged, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)  # retrieve the contours as a list, with a simple approximation model
...
op = cv2.getPerspectiveTransform(approx, pts)  # get the top or bird's eye view effect
